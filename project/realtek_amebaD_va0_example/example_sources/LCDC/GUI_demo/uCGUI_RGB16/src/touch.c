...
void CT_GPIO_Init(void)
{
	...
	GPIO_InitStruct_Temp.GPIO_Pin = GT_RST_PIN;
	...
	PAD_PullCtrl(GT_RST_PIN, GPIO_PuPd_UP);

	GPIO_InitStruct_Temp.GPIO_Pin = RGB_43_SCREEN_RST;
	GPIO_InitStruct_Temp.GPIO_PuPd = GPIO_PuPd_NOPULL;
	GPIO_InitStruct_Temp.GPIO_Mode = GPIO_Mode_OUT;
	GPIO_Init(&GPIO_InitStruct_Temp);
	PAD_PullCtrl(RGB_43_SCREEN_RST, GPIO_PuPd_UP);
