This m4a self parse example is used to play m4a files from the SDCARD. In order to run the example the following steps must be followed.
	...
	2. Set the parameter configTOTAL_HEAP_SIZE to 270*1024 in FreeRTOSConfig.h
	...
	4. Enable PSRAM and locate large array into PSRAM in the example file "example_audio_m4a_selfparse.c".
	
	5. Remove component\common\audio\libav\errno.h for compile pass!!!
