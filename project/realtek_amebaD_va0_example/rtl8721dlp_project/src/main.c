...
void app_rtc_init(void)
{
	...
	//InterruptRegister(app_rtc_irq_handler, RTC_IRQ, NULL, 4);
...
int main(void)
{
	...
	InterruptRegister((IRQ_FUN)IPC_INTHandler, IPC_IRQ_LP, (u32)IPCM4_DEV, 10);
	InterruptEn(IPC_IRQ_LP, 10);
	...
	app_rtc_init();
	if (ps_config.km0_enable_key_touch) {
