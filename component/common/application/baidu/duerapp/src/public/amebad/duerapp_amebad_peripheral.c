...
#define GPIO_PLAY_STOP_PIN			PA_4
#define GPIO_PLAY_VOLUME_UP			PA_2
#define GPIO_PLAY_VOLUME_DOWN		PA_1
#define GPIO_PLAY_STOP				PA_5
#define GPIO_LED_WING_LEFT_PIN		PA_6
#define GPIO_LED_WING_RIGHT_PIN		PB_23
#define GPIO_LED_HEAD_PIN			PA_25
#define GPIO_LED_VOICE				PA_26
...
//1010
u8 volume_6548_value[] = {0x00, 0x50, 0x5a, 0x64, 0x6e, 0x78, 0x82, 0x8c, 0x96, 0xa0, 0xaf};
...
{		
    ...
    SET_VOLUME(volume_6548_value[current_volume_index], volume_6548_value[current_volume_index]);
    DUER_LOGI("Volume Set, index %d, value %d\r\n", current_volume_index, volume_6548_value[current_volume_index]);
}
...
u16 duerapp_play_mp3_volume_get()
{
    ...
    switch(volume_16){
        ...
        default:
            volume_index = 0;
            SET_VOLUME(volume_6548_value[0], volume_6548_value[0]);
            break;
    }
