...
THis is an example for two pairs of MMF source-sink:
1. One source (h264 file or mux streaming combined with GEO cam) and two sinks (rtsp service and mp4 recording) and another . 
2. One source (rtp) and one sink(mmf_sink_i2s(.wav) or mmf_sink_mp3(.mp3))
